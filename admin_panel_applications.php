            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-md-flex align-items-center">
                        <div>
                            <h4 class="card-title">Активные заявки</h4>
                        </div>
                    </div>
                    <!-- title -->
                </div>
                    ...
                    <table class="table v-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="submit"  onclick="fetch('/vendor/take_user.php?id=<?php echo $result['id'];?>');  setTimeout(location.reload(), 3000);">Принять</button> <button onclick="fetch('/vendor/delete_user.php?id=<?php echo $result['id'];?>');  setTimeout(location.reload(), 5000);">Отклонить</button></td>
                            </tr>
                            <?php }?>
                        </tbody>
                    </table>
